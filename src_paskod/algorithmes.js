/*
    NAME : algorithmes.js
    PURPOSE : Implémentation pure des 5 algorithmes de tri classiques
              (bulles, sélection, insertion, rapide, fusion)
              Sans aucune dépendance au DOM - logique métier isolée
